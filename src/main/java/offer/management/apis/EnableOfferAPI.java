...
public class EnableOfferAPI {

    UserManager userManager = new UserManager();

    public void enableOffer(String userId, List<String> customerIds, String offerName) throws IllegalAccessException {
        ...
        userManager.enableOfferForCustomers(customerIds, offerName);
